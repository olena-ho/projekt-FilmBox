...
//create different text depending on whether the daysDiffFromPremiere is a positive or negative number
const premiereDateText = daysDiffFromPremiere > 0 ? `je za ${daysDiffFromPremiere} dní` : `bylo před ${Math.abs(daysDiffFromPremiere)} dny`;
